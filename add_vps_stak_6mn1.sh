...
echo -e ${YELLOW}"Welcome to the Northern Automated Update 3.1.0 (6in1)."${NC}
...
wget https://github.com/northern-community/Northern/releases/download/3.0.0/northern_linux.3_1_0.tar.gz
